...
plt.savefig('12.png')
st.pyplot(fig)
doc.add_picture('12.png', width=docx.shared.Inches(6), height=docx.shared.Inches(4))
...
plt.savefig('13.png')
st.pyplot(fig)
doc.add_picture('13.png', width=docx.shared.Inches(6), height=docx.shared.Inches(4))
...
plt.savefig('14.png')
st.pyplot(fig)
doc.add_picture('14.png', width=docx.shared.Inches(6), height=docx.shared.Inches(4))
...
plt.savefig('15.png')
st.pyplot(fig)
doc.add_picture('15.png', width=docx.shared.Inches(6), height=docx.shared.Inches(4))
...
plt.savefig('16.png')
st.pyplot(fig)
doc.add_picture('16.png', width=docx.shared.Inches(6), height=docx.shared.Inches(4))
...
plt.savefig('17.png')
st.pyplot(fig)
doc.add_picture('17.png', width=docx.shared.Inches(6), height=docx.shared.Inches(4))
