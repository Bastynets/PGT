...
st.write("""# """)
st.write(" *Дано:* ")
st.write(""" P0 = """ + str('{:.1}'.format(float(P0))) + """ МПа""")
st.write(""" h0 = """ + str('{:.3}'.format(float(h0))) + """ кДж/кг""")
st.write(""" dрс = """ + str(drs) + """ м """)
st.write(""" Z = """ + str(Z) + """ шт """)
st.write(""" G0 = """ + str('{:.2}'.format(float(G0))) + """ кг/с """)
st.write(""" n = """ + str(n) + """ Гц """)
st.write(""" eta_oi = """ + str('{:.2}'.format(float(etaoi))) + """ """)
st.write(""" Pz = """ + str('{:.1}'.format(float(Pz))) + """ МПа """)
